...
hVirtualDesktopAccessor := DllCall("LoadLibrary", "Str", A_ScriptDir . "\windows-desktop-switcher\VirtualDesktopAccessor.dll", "Ptr")
...
#j::GoToPrevDesktop()
#k::GoToNextDesktop()
#LButton::GoToPrevDesktop()
#RButton::GoToNextDesktop()
